...
The first computer I started working with was an [Amstrad PCW](https://en.wikipedia.org/wiki/Amstrad_PCW). This device operated on the [CP/M](https://en.wikipedia.org/wiki/CP/M) operating system, and it was here that I initiated my programming journey using the [Mallard BASIC language](https://en.wikipedia.org/wiki/Mallard_BASIC). (Resource: [[Mallard Basic]])
